...
router.get("/database", async (req, res)=>{
    ...
    let output= data.map((person)=>{
        return `${person.name} is ${person.age} years old, is ${person.height}m tall, weighs ${person.weight}kg and has a BMI of ${person.bmi} \n`
...
router.post("/find", async (req, res)=>{
    ...
    let output= "The patient is "+ data.name + " \n" +" aged: "+ data.age + " \n"+ " weight: "+ data.weight+ " \n"+ " height: " + data.height
    res.send(output)
...
router.post("/delete", async (req, res)=>{
    ...
    let output= "The patient with "+ data.name + " \n" +" aged: "+ data.age + " \n"+ " weight: "+ data.weight+ " \n"+ " height: " + data.height +" has been deleted"
    res.send(output)
